...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/28 18:11:55 by aminko            #+#    #+#             */
/*   Updated: 2024/02/11 18:40:39 by aminko           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	my_img_to_xpm(t_win *win, char *path, t_win *data)
{
	...
	check_malloc(data->img, "couldn't alloc texture img", 21);
	data->addr = mlx_get_data_addr(data->img, &data->bpp, \
			&data->l_len, &data->end);
	check_malloc(data->addr, "couldn't alloc texture addr", 22);
}
